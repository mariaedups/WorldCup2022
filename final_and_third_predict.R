...
df_clean_final <- read.csv(paste0(path,'df_test_final.csv'))
df_clean_third <- read.csv(paste0(path,'df_test_third_place.csv'))
...
write.csv(winner_pred_df_final_and_third,paste0(path,'final_and_third_match_predictions.csv'))