...
df_clean_quarter_finals <- read.csv(paste0(path,'df_test_quarter_finals.csv'))
...
write.csv(winner_pred_df_quarters,paste0(path,'quarter_final_match_predictions.csv'))
